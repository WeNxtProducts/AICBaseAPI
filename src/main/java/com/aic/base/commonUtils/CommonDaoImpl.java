...
public class CommonDaoImpl implements CommonDao {
	...
	public List<MenuResultDTO> getMenuList(String groupId, String query) {
		String sql = query;
		List<MenuResultDTO> result = template.query(sql, new Object[] { groupId },
				new BeanPropertyRowMapper<>(MenuResultDTO.class));
		return result;
	}
	...
	public List<MenuResultDTO> getChildMenuList(String parentId, String groupId, String query) {
		String sql = query;
		List<MenuResultDTO> result = template.query(sql, new Object[] { parentId, groupId },
				new BeanPropertyRowMapper<>(MenuResultDTO.class));
		return result;
	}
	...
	public List<LM_PROG_FIELD_DEFN_NEW> getFieldList(String screenCode, String screenName, String query) {
		String sql = query;
		List<LM_PROG_FIELD_DEFN_NEW> result = template.query(sql, new Object[] { screenCode, screenName },
				new BeanPropertyRowMapper<>(LM_PROG_FIELD_DEFN_NEW.class));
		return result;
	}
	...
	public service_url_mapping getUrlData(AsyncDTO object) {
		...
		service_url_mapping result = template.queryForObject(sql,
				new Object[] { object.getScreenCode(), object.getScreenName(), object.getServiceName() },
				new BeanPropertyRowMapper<>(service_url_mapping.class));
		return result;
	}
	...
	public List<LM_PROG_FIELD_DEFN_NEW> getFrontFormDetails() {
		...
		List<LM_PROG_FIELD_DEFN_NEW> result = template.query(sql,
				new BeanPropertyRowMapper<>(LM_PROG_FIELD_DEFN_NEW.class));
		return result;
	}
	...
	public List<LovToJsonDTO> lovToJson(String qm_QUERY, String string, String string2) {
		List<LovToJsonDTO> result = template.query(qm_QUERY, new Object[] { string, string2 },
				new BeanPropertyRowMapper<>(LovToJsonDTO.class));
		return result;
	}
...
//		}
	...
	public lt_policy getQuotationFields(String string, String string2, Object object) {
		...
		lt_policy result = template.queryForObject(query, new Object[] { object.toString() },
				new BeanPropertyRowMapper<>(lt_policy.class));
		return result;
	}
	...
	public LM_MENU_USERS getUserFields(String string, String string2, Object object) {
		...
		LM_MENU_USERS result = template.queryForObject(query, new Object[] { object.toString() },
				new BeanPropertyRowMapper<>(LM_MENU_USERS.class));
		return result;
	}
	...
	public List<MRVKeyValue> getMrvFetchList(Object object) {
		...
		List<MRVKeyValue> result = template.query(query, new Object[] { object },
				new BeanPropertyRowMapper<>(MRVKeyValue.class));
		return result;
	}
	...
	public LM_CUSTOMER getCustomerFields(String string, String string2, Object object) {
		...
		LM_CUSTOMER result = template.queryForObject(query, new Object[] { object },
				new BeanPropertyRowMapper<>(LM_CUSTOMER.class));
		return result;
	}
	...
	public List<MenuResultDTO> getReportMenuList(String query) {
		return template.query(query, new BeanPropertyRowMapper<>(MenuResultDTO.class));
	}

	public List<MenuResultDTO> getChildReportList(String parentId, String query) {
		return template.query(query, new Object[] { parentId }, new BeanPropertyRowMapper<>(MenuResultDTO.class));
	}

	public List<MenuResultDTO> getsubChildReportMenuList(String childId, String query) {
		return template.query(query, new Object[] { childId }, new BeanPropertyRowMapper<>(MenuResultDTO.class));
	}
